...
1. Start at the runway diagnosis. The loaded manufacturing case fails immediately because simultaneous collection, debt, and inventory shocks consume more cash than the company holds.
